...
export default function ResultsDisplay({ result, onReset }: ResultsDisplayProps) {
  ...
  return (
    <div className="min-h-screen" style={{background: 'var(--bg)'}}>
      ...
      {/* Disclaimer Banner */}
      <div style={{background: '#4a3a2a', borderBottom: '1px solid #5a4a3a', padding: '6px 0'}}>
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center">
            <svg style={{width: '12px', height: '12px', minWidth: '12px', minHeight: '12px', marginRight: '6px', color: 'var(--warning)', flexShrink: 0}} fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
            </svg>
            <p style={{fontSize: '11px', color: 'var(--warning)', lineHeight: '1.4'}}>
